...
class OfferRideViewController: UIViewController, UISearchBarDelegate, LocateOnTheMap {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        {
            let ride = Ride.init(startLocation: startPoint, endLocation: endPoint, tripStartTime: tripStartTime, estimatedArrivalTime: estimatedArrivalTime, tripDuration: tripDuration, distance: distance, userID: nil, rideID: nil, userInfo: nil, price: nil, numberOfSeats: nil, numberOfAvailableSeats: nil)
